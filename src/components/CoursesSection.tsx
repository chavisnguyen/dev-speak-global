...
const courses = [
  {
    ...
    outcomes: [
      ...
      "Sẵn sàng học IT Speaking để chuyển từ \"biết\" sang \"nói được\"",
    ],
  ...
  },
  {
    ...
    level: "Level 3",
    name: "Interview",
    subtitle: "Trả lời phỏng vấn đúng trọng tâm.",
    icon: Target,
    color: "career",
    ...
    outcomes: [
      ...
      "Trả lời phỏng vấn đúng trọng tâm, phản biện khéo léo trong phỏng vấn",
  ...
  },
  {
    ...
    outcomes: [
      ...
      "Giao tiếp hiệu quả và đảm bảo quyền lợi các bên liên quan",
      "Hỗ trợ collaboration, ad-hoc meeting; tư vấn chiến lược",
